  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(HttpMethod.GET, "/api/profile-photos/download/**").permitAll()
            .requestMatchers(HttpMethod.POST, "/api/profile-photos/upload").authenticated()
            .requestMatchers(HttpMethod.DELETE, "/api/profile-photos/delete/**").authenticated()
